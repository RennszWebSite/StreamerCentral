    ...
    <section id="about" className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="md:w-1/2">
            <h2 className="text-3xl md:text-4xl font-accent font-bold text-primary mb-6">About RENNSZ</h2>
            ...
            <div className="flex flex-wrap gap-4">
              <a 
                ...
                className="inline-flex items-center px-5 py-3 bg-[#5865F2] text-white font-heading font-semibold rounded-lg hover:bg-[#5865F2]/90 transition-colors"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center px-5 py-3 bg-black text-white font-heading font-semibold rounded-lg hover:bg-black/90 transition-colors"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center px-5 py-3 bg-[#E4405F] text-white font-heading font-semibold rounded-lg hover:bg-[#E4405F]/90 transition-colors"
              >
                <span>Instagram</span>
                <svg className="w-5 h-5 ml-2" fill="currentColor" viewBox="0 0 24 24">
